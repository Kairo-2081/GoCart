...
ALTER TABLE customers DROP COLUMN IF EXISTS username, DROP COLUMN IF EXISTS email, DROP COLUMN IF EXISTS password;
ALTER TABLE sellers DROP COLUMN IF EXISTS username, DROP COLUMN IF EXISTS email, DROP COLUMN IF EXISTS password;
ALTER TABLE admins DROP COLUMN IF EXISTS username, DROP COLUMN IF EXISTS email, DROP COLUMN IF EXISTS password;
